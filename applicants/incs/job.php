...
//$pdf->Image('../../tcpdf/resume_propickd.png', 1, 1, '', '', 'png', 'http://www.tcpdf.org', '', true, 300, '', false, false, 0, 'CM', false, true);
...
//$pdf->Image('../../tcpdf/resume_propickd.png', 1, 1, '', '', 'PNG', '', '', false, 300, '', false, false, 0, 'CM', false, false);
$pdf->Image('../../tcpdf/resume_propickd.png', '', '', '', '', 'PNG', '', '', false, 300, '', false, false, 0, 'CM', false, true);

$pdf->AddPage();
$horizontal_alignments = array('C');
$vertical_alignments = array('M');
...
// test all combinations of alignments
	...
	$x = 15;
		...
		$pdf->Rect($x, $y, '', '', 'F', array(), array(128,255,128));
		$pdf->Image('../../tcpdf/resume_propickd.png', '', $y, '', '', 'PNG', '', '', false, 300, '', false, false, 0, 'CM', false, true);
		$x += 32; // new column
