...
$style2 = array('position'=>'', 'border'=>false, 'padding'=>0, 'fgcolor'=>array(0,0,0), 'bgcolor'=>array(255,255,255), 'text'=>true, 'font'=>'helvetica', 'fontsize'=>8, 'stretchtext'=>4);
			...
			$params = $pdf->serializeTCPDFtagParameters(array($uniquelink.' '.$alink, 'C39', '', '', '', 11, 0.4, $style2, 'N'));
...
$subtable = '<table border="0" cellspacing="6" cellpadding="4">
				...
				<tr>
					<td width="60%">Applicant Name: <b>'.$fname.' '.$lname.'</b></td>
					<td width="40%">Father\'s Name: <b>'.$mname.'</b></td>
				</tr>
				<tr>
					<td width="60%">Date of Appointment: <b>'.$adate.'</b></td>
					<td width="40%">Time of Appointment: <b>'.$atime.'</b></td>
				</tr>
				<tr>
					<td width="60%">Appointment Type: <b>'.$atypes.'</b></td>
					<td width="40%" align="">Appointment No.: <b>'.$alink.'</b></td>
				</tr>
				<tr>
					
					<td width="60%">'.$html.'</td>
					<td width="40%" align="">Window: <b>'.$window.'</b></td>
				...
				<tr>
					...
					This is your Appointment letter for <b>'.$atypes.'</b>, you need to carry this letter including other necessary documents when you come, please reach there <u>before</u> <b>'.$atime.'</b> so that you don\'t miss the appointment.<br/><br/>
					Thank you
					</td>
...
// ---------------------------------------------------------
if (!is_dir($uniquelink.'/al'))
{
	mkdir($uniquelink.'/al', 0777, true);
}
// Close and output PDF document
// This method has several options, check the source code documentation for more information.
//$pdf->Output('example_001.pdf', 'I');
//$pdf->Output( $_SERVER['DOCUMENT_ROOT'].'/AM/applicants/'.$uniquelink.'/al/appointment-'.$alink.'.pdf', 'F');
//$pdf->Output( $_SERVER['DOCUMENT_ROOT'].'demo/Application-management/applicants/'.$uniquelink.'/al/'.$alink.'.pdf', 'F');
$pdf->Output(__dir__ .'/'.$uniquelink.'/al/appointment-'.$alink.'.pdf', 'F');
